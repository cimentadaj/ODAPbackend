...
#' Check if the following columns are numeric: (`Deaths`, `Exposures`, `Age`, and `AgeInt`).
#' @description 
...
#' Check if any of the crucial columns are missing from the data: (`Deaths`, `Exposures`, `Age`).
#' @description
#' @param data tibble. A tibble generated by the output of the read_data function.
#' @return A data.frame with 3 columns: message - `check` - the name of the test, `message` - The error message with corresponding information generated if the test is failed (if the test is passed evaluates to NA), `pass` - binary result of the test either "Fail" or "Pass".
...
#' Check number of rows in the data. NOTE: only using the following columns: (`Deaths`, `Exposures`, `Age`, and `AgeInt`).
#' @description
#' @param data tibble. A tibble generated by the output of the read_data function.
#' @return A data.frame with 3 columns: message - `check` - the name of the test, `message` - The error message with corresponding information generated if the test is failed (if the test is passed evaluates to NA), `pass` - binary result of the test either "Fail" or "Pass".
#' @examples1
...
#' Check if there missing data in any of the following columns: (`Deaths`, `Exposures`, `Age`, and `AgeInt`). NOTE: the NA value is allowed for the open age interval in `AgeInt` column.
#' @description
#' @param data tibble. A tibble generated by the output of the read_data function.
#' @return A data.frame with 3 columns: message - `check` - the name of the test, `message` - The error message with corresponding information generated if the test is failed (if the test is passed evaluates to NA), `pass` - binary result of the test either "Fail" or "Pass".
#' @importFrom stringr str_c str_flatten
...
# Checks the data on sex provided by the user. We expect it ot be provided and contain information on either Males or Females or both. So that the column sex has either one, or two levels.
#' @description
#' @param data tibble. A tibble generated by the output of the read_data function.
